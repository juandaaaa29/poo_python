class Estudiante:
    ...
    def ver_informacion(self):
        ...
        """
        promedio = self.obtener_promedio() if self.calificaciones else 0.0 #el error esta en que se usaba el atribito "calificacion", pero estaba antes definido como "calificaciones , es solo un error de escritura"
        return (
